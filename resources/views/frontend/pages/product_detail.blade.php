...
@endsection
@section('title','Ecommerce Shopping || PRODUCT DETAIL')
...
@php
$waPhone = '8801799789854'; // seller WhatsApp number
$waText = urlencode("Hi! I want to order: {$product_detail->title} (" . url()->current() . ")");
@endphp

</br>
<a href="https://wa.me/{{ $waPhone }}?text={{ $waText }}" target="_blank" class="btn btn-success mt-2 w-50">
    💬 Order via WhatsApp
</a>

<!--
<form method="POST" action="{{ route('whatsapp.order') }}"> 
	@csrf 
	<input type="hidden" name="product_id" value="{{ $product_detail->id }}"> 
	<input type="text" name="customer_name" placeholder="Your name (optional)" class="form-control my-2"> 
	<input type="text" name="customer_phone" placeholder="Phone number" class="form-control my-2" required> 
	<textarea name="message" placeholder="Optional message" class="form-control my-2"></textarea> 
	<button type="submit" class="btn btn-success w-100">💬 Submit WhatsApp Order</button> 
</form>-->
...
<div class="modal fade" id="phoneOrderModal" tabindex="-1">
  <div class="modal-dialog">
    <form class="modal-content" method="POST" action="{{ route('phone.order') }}">
        @csrf
        <input type="hidden" name="product_id" value="{{ $product_detail->id }}">
        <input type="hidden" name="channel" value="phone">

        <div class="modal-header">
            <h5 class="modal-title">Order by Phone</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>

        <div class="modal-body">
            <input type="text" name="customer_name" class="form-control mb-2" placeholder="Your Name" required>
            <input type="text" name="customer_phone" class="form-control mb-2" placeholder="Phone Number" required>
            <textarea name="message" class="form-control mb-2" placeholder="Note (optional)"></textarea>
        </div>
...
-->
    ...
    @endif
		...
		<!--/ End Shop Single -->
		<!-- Start Most Popular -->
	<div class="product-area most-popular related-product section" style="display:none;">
        <div class="container">
            <div class="row">
				<div class="col-12">
